...
(function() {
  ...
  */
  YAHOO.Bubbling = function () {
	...
	/**
	* * Este m�todo determina la acci�n por defecto para un elemento
	* @public
	...
	*/
	...
	/**
	* * Este m�todo determina el primer tab hijo basado en el tabName
	* @public
	...
	*/
	...
	/**
	* * Este m�todo determina si un evento es interno o no a un contenedor...
	* @public
