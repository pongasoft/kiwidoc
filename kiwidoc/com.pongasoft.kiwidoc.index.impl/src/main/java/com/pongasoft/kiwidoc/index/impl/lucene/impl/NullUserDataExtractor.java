 ...
 */
public class NullUserDataExtractor implements UserDataExtractor
{
  /**
   * Constructor
   */
  public NullUserDataExtractor()
  {
  }
   ...
   */
  public Object[] extractUserData(IndexSearcher indexSearcher) throws IOException
  {
    return null;
  }
}
