...
import com.pongasoft.util.core.exception.BusinessException;
...
public class DuplicateLibraryException extends BusinessException
{
  ...
  public DuplicateLibraryException(String message, Throwable cause)
  {
    super(message, cause);
  }

  public DuplicateLibraryException(Throwable cause)
  {
    super(cause);
  }
}
