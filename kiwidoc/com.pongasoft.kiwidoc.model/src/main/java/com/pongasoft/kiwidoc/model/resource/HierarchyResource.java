 ...
 */
public class HierarchyResource extends AbstractResource<HierarchyResource, LibraryVersionResource>
{
   ...
   * Constructor
   */
  public HierarchyResource(LibraryVersionResource libraryVersionResource)
  {
   ...
   */
  public HierarchyResource clone(LibraryVersionResource parent)
  {
    return new HierarchyResource(parent);
  }
