 ...
 */
public class NoUserDataLuceneIndexSearcherImpl<T> implements LuceneIndexSearcher<T>
{
   ...
   * Constructor
   */
  public NoUserDataLuceneIndexSearcherImpl(IndexSearcher indexSearcher)
  {
    ...
    throws IOException
  {
    _indexSearcher.search(query, new HitCollector()
    {
      ...
      {
        collector.collect(doc, score, null);
      }
    });
    return collector;
  }
