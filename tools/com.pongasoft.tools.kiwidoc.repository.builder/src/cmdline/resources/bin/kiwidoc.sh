...
OPTIONS="-s $BASEDIR/conf/maven-settings.xml"
...
java $JVM_LOG4J $JVM_DEBUG $JVM_CLASSPATH $JAVA_OPTS com.pongasoft.kiwidoc.repository.builder.KiwidocCmdLine $OPTIONS $@
