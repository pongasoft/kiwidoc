 ...
 */
public class ManifestResource extends AbstractResource<ManifestResource, LibraryVersionResource>
{
   ...
   * Constructor
   */
  public ManifestResource(LibraryVersionResource libraryVersionResource)
  {
   ...
   */
  public ManifestResource clone(LibraryVersionResource parent)
  {
    return new ManifestResource(parent);
  }
